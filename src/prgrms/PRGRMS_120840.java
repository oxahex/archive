...
public class PRGRMS_120840 {
     ...
     *
     *     추가적으로 받은 코멘트
     *     공식의 물리적인 의미를 생각하시면 반드시 모든 소인수가 포함된다는 사실(소인수가 남으면 항상 소숫점이 발생하므로)을 알고 시작할 수 있습니다.
     *     이렇게 수학적으로 파고들지 않고 파악할 수 있는 정도는 괜찮으나, 이 이상 수학적으로(정수론 기반의) 파고들어야 한다면 굳이 공부하지 않아도 되는 부분일 것 같네요!
     *     실무에서는 이 방법이 떠오르지 않을 경우 BigInteger를 사용하되, 성능적인 이슈가 있을 때 최적화 방법으로 선택하시면 좋을 것 같습니다.
     * </pre>
     * */
